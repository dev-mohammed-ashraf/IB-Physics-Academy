...
export default function FloatingButtons() {
  ...
  return (
    <>
      ...
      {/* WhatsApp contact */}
      <a
        href="https://wa.me/201016747876"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
        title="Chat on WhatsApp"
        className="fixed bottom-6 right-6 z-50 flex size-12 cursor-pointer touch-manipulation select-none items-center justify-center rounded-full bg-green-500 text-white shadow-lg shadow-green-900/30 transition-transform duration-300 hover:scale-110 hover:bg-green-600 dark:shadow-black/40"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
